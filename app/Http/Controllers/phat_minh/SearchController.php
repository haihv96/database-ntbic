...
class SearchController extends Controller
{
	public function getSearch(Request $request) {
		...
		*/
		if ($linh_vuc_khcn != 0) {
			$linh_vuc1 = DB::table('linh_vuc_san_pham')->find($linh_vuc_khcn);
			$result = $result->where('linh_vuc',$linh_vuc1->linh_vuc);
		}
		...
		*/
		if ($loai_phat_minh_sang_che != 0) {
			$loai_phat_minh1 = DB::table('loai_phat_minh_sang_che')->find($loai_phat_minh_sang_che);
			$result = $result->where('loai_phat_minh_sang_che',$loai_phat_minh1->loai_phat_minh_sang_che);
		}

		return view('search_result.phat_minh_sang_che')->with(['linh_vuc'=>$linh_vuc,'loai_phat_minh'=>$loai_phat_minh,'phat_minh'=>$result]);
	}
}